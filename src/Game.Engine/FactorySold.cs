...
/// cref="FactoryResidualValueCalculator"/>, 2026-08-23), то есть половина (при текущем коэффициенте
/// 0.5) от той оценки, что показывает итоговый счёт в конце игры (<see cref="FinalScoreCalculator"/>)
/// — намеренная разница: мгновенная продажа — это спешка, эталонная оценка в конце партии — нет.
/// Рабочие проданной фабрики перестают числиться вместе с ней, без отдельного события увольнения
/// (то же упрощение, что и у постройки).
/// </summary>
