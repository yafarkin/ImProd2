...
{
    /// <summary>
    /// (Опц.) налоги (SPEC §5.10) в этот шаг не входят — сознательно отложены, см. AGENTS-память
    /// (депозиты туда же относились, но убраны вместе с банковским займом как классом механики,
    /// docs/TODO.md #23, а не отложены). Плата за превышение склада (Блок 9.2, SPEC §5.7) уже входит — считается по
