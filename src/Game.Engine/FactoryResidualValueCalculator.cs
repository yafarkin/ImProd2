...
/// 2026-08-23) — от <see cref="FactoryDefinitionConfig.LiquidationValueCoefficient"/> (пол, полностью
/// убитая фабрика, <c>Condition=0</c>) линейно вверх до полной <see
/// cref="FactoryDefinitionConfig.BuildCost"/> (только что построена или отремонтирована,
/// <c>Condition=1</c>). Раньше <see cref="FinalScoreCalculator"/>/<see cref="IdealHallCalculator"/>/
/// <see cref="GameSession.SellFactory"/> считали плоскую долю (<c>BuildCost *
...
/// всех трёх мест, чтобы не расходились.
/// </summary>
