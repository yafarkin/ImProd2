...
/// системной продажи (<c>MarketSaleCalculator.SystemSaleMarginMultiplier</c>, действует только под
/// <c>PricingModel.CostPlus</c> — под экзогенной моделью доходность задаёт лестница цен, блок 11.2) в списке сознательно
