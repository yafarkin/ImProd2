...
public sealed class GameSessionHost
{
    ...
    /// независимое состояние и репутация») — переход от тренировочной игры к основной. Баланс
    /// каждой команды обнуляется вместе со всем остальным состоянием — «полностью независимое
