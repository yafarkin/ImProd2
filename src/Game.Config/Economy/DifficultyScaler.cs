...
/// рычаг эскалации командной зарплаты убран вместе с самой прогрессией (2026-08-23,
/// Game.Engine.FinanceCalculator — не различала эффективный найм от раздутого при реалистичном
/// числе фабрик, дублировала убывающую отдачу выработки без своей пользы); docs/difficulty.md пока
/// не переписан под новое число, см. TODO) по непрерывному
