...
/// пользователя, rebalance/2-sector-stepwise, 2026-08-22, поднято тем же днём с 5%/30% до 10%/40%):
/// продажа системе — везде <c>Game.Engine.MarketSaleCalculator.SystemSaleMarginMultiplier</c>
/// (себестоимость + 10%, без деления по уровню передела — до этого была таблица
