...
public class GameConfigValidatorTests
{
    ...
    public void Valid_Config_Has_No_Errors()
    {
        var config = GameConfigTestBuilder.Build(
            ...
            factoryDefinitions: new[]
            {
                ...
                new FactoryDefinitionConfig { Id = "steel-mill", Name = "Завод", SectorId = "A", RecipeIds = new[] { "sheet-from-ore" }, BuildCost = 100m, LiquidationValueCoefficient = 0.5m, FixedCostPerTurn = 0m },
                new FactoryDefinitionConfig { Id = "rolling-mill", Name = "Стан", SectorId = "A", RecipeIds = new[] { "rebar-from-sheet" }, BuildCost = 100m, LiquidationValueCoefficient = 0.5m, FixedCostPerTurn = 0m },
            });
    ...
    public void FactoryDefinition_Offering_Recipe_From_Another_Sector_Is_Reported()
    {
        var config = GameConfigTestBuilder.Build(
            ...
            factoryDefinitions: new[]
            {
                new FactoryDefinitionConfig { Id = "wrong-mill", Name = "Не тот завод", SectorId = "B", RecipeIds = new[] { "sheet-from-ore" }, BuildCost = 100m, LiquidationValueCoefficient = 0.5m, FixedCostPerTurn = 0m },
            });
    ...
    public void FactoryDefinition_Referencing_Unknown_Recipe_Is_Reported()
    {
        var config = GameConfigTestBuilder.Build(
            ...
            factoryDefinitions: new[]
            {
                new FactoryDefinitionConfig { Id = "steel-mill", Name = "Завод", SectorId = "A", RecipeIds = new[] { "no-such-recipe" }, BuildCost = 100m, LiquidationValueCoefficient = 0.5m, FixedCostPerTurn = 0m },
            });
