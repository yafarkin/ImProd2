...
public class SystemSaleStepTests
{
    ...
    public void Run_Returns_Nothing_When_There_Are_No_Pending_Requests()
    {
        ...
        var changes = SystemSaleStep.Run(team, log.State.Market, TestGameConfig.MaterialCosts, TestGameConfig.Resolved.Raw.Economy, TestGameConfig.Resolved.Materials, currentTurn: 1, log.Entries);
